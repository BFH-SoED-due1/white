...
public class EndUserModel extends AbstractModel {
	...
	private EndUserModel() {
		...
		try {
			...
			// TODO Very bad programming style! What happens if an exception
			// occurs?
			e.printStackTrace();
		}
	}
	...
	public EndUser getEndUserById(int ID) {
		List<EndUser> endUserList = uniqueModel.getData();
	...
	public boolean saveUser(String fName, String lName, String eMail, String password) {
		...
		try {
			...
			preparedStatement = connection
					.prepareStatement("INSERT INTO ENDUSER (ID, FNAME, LNAME, EMAIL, PASSWORD) VALUES (?, ?, ?, ?, ?)");
